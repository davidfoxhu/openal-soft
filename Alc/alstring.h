...
static __inline void al_string_deinit(al_string *str)
{ VECTOR_DEINIT(*str); }
...
static __inline size_t al_string_length(const_al_string str)
{ return VECTOR_SIZE(str); }

static __inline ALboolean al_string_empty(const_al_string str)
{ return al_string_length(str) == 0; }

static __inline const al_string_char_type *al_string_get_cstr(const_al_string str)
